...
public class BasicEntityBuilder {
	...
	public static IEntity createCube(double size, double centerX, double centerY,double centerZ) {
		...
		Tetrahedron tetra = new Tetrahedron(
										...
										new MyPolygon(Color.WHITE,p1,p2,p6,p5),		// Bottom face
										new MyPolygon(Color.YELLOW,p1,p5,p8,p4),	// left face
										new MyPolygon(Color.GREEN,p2,p6,p7,p3),		// Right face
										new MyPolygon(new Color(255,102,0),p4,p3,p7,p8),	// Top face
